...
The later [overnight hardening checkpoint](docs/verification/2026-09-18-commercial-readiness.md) passed **335 Swift tests, 14 packaging regressions, 9 verification regressions, and native development bundle checks**. It adds snooze integrity, Settings-first lifecycle gating and nonblocking refresh waiting. This does not replace the hardware, live-provider or release-distribution acceptance gates.
