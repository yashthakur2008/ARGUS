...
The later [overnight hardening checkpoint](docs/verification/2026-09-18-commercial-readiness.md) passed **345 Swift tests, 14 packaging regressions, 23 verification regressions, and native development bundle checks**. It adds snooze integrity, Settings-first lifecycle gating, draft-preserving settings reload, and nonblocking refresh/draft-save waiting. This does not replace the hardware, live-provider or release-distribution acceptance gates.
