...
The later [hardening checkpoint](docs/verification/2026-09-18-commercial-readiness.md) passed **365 Swift tests, 14 packaging regressions, 23 verification regressions, and native development bundle checks**. It adds snooze integrity, Settings-first lifecycle gating, draft-preserving editors, guarded DST boundaries, logically ordered scheduling refreshes, and off-main refresh, draft-save and notice-source waiting. This does not replace the hardware, live-provider or release-distribution acceptance gates.
...
The development machine's installed Command Line Tools are inconsistent. A verified official Swift 6.1.2 package was extracted into scratch without changing system tools. Its exact development-only path and verification history are in the [evidence record](docs/verification/2026-09-17-reminders-slice.md). A clean Xcode 16.4 development build and all 365 Swift tests now also pass on GitHub Actions; see the [hosted verification checkpoint](docs/verification/2026-09-18-hosted-ci.md). Distribution signing and native acceptance remain separate gates.
